/*Questão 42. Escreva um algoritmo que leia os valores das variáveis X e A e calcule o valor de
S dado por:
...
int main()
{
    ...
    while ((A >= 0 && A <= 19) || (X == 0))
    {
        printf("\nOu o valor de A quando subtraído por algum número do intervalo [1,20] resultará em 0 ou o valor de X se for igual a 0 resultará em 0 e não existe divisão por 0.");
